...
interface WebsiteTableSkeletonProps {
  rows?: number;
}

export const WebsiteTableSkeleton = memo(({ rows = 5 }: WebsiteTableSkeletonProps) => {
  return (
...
WebsiteTableSkeleton.displayName = 'WebsiteTableSkeleton';
