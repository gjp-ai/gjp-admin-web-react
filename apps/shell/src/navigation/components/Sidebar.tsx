  ...
  const navItems: NavItem[] = useMemo(() => [
    ...
    },
    {
      ...
      children: [
        ...
        {
          key: 'edu-multiple-choice-question',
          title: t('multipleChoiceQuestion.title', 'Multiple Choice Question'),
          path: '/edu-multiple-choice-question',
          icon: ListChecks,
        },
        {
          key: 'edu-fill-blank-question',
          title: t('fillBlankQuestion.title', 'Fill Blank Question'),
          path: '/edu-fill-blank-question',
          icon: SquarePen,
        },
        {
          key: 'edu-free-text-question',
          title: t('freeTextQuestion.title', 'Free Text Question'),
          path: '/edu-free-text-question',
          icon: MessageCircleQuestion,
        },
        {
          key: 'edu-true-false-question',
          title: t('trueFalseQuestion.title', 'True/False Question'),
