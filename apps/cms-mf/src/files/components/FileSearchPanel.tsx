...
import type { FileSearchFormData } from '../types/file.types';
import { LANGUAGE_OPTIONS } from '../constants';

interface FileSearchPanelProps {
  searchFormData: FileSearchFormData;
  loading: boolean;
  onFormChange: (field: keyof FileSearchFormData, value: any) => void;
  onSearch: () => void;
  onClear: () => void;
}
...
const FileSearchPanel: React.FC<FileSearchPanelProps> = ({
  ...
  // Get file tags from local storage filtered by current language
        ...
        <Box sx={{
          ...
          <Box>
            ...
            <TextField
              ...
              placeholder={t('files.filters.searchByName')}
              disabled={loading}
              sx={{
              ...
              >
                ...
                {LANGUAGE_OPTIONS.map((option) => (
                  <MenuItem key={option.value} value={option.value}>
                    {t(`files.languages.${option.value}`)}
                  </MenuItem>
                ))}
              </Select>
            </FormControl>
          ...
          <Box>
            ...
            <FormControl fullWidth size="small">
              ...
              >
                <MenuItem value="">{t('files.filters.all')}</MenuItem>
                <MenuItem value="true">{t('files.status.active')}</MenuItem>
                <MenuItem value="false">{t('files.status.inactive')}</MenuItem>
              </Select>
            </FormControl>
          </Box>
        </Box>
